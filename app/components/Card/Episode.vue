...
<template>
  <NuxtLink :href="url"
    class="flex aspect-square max-w-[318px] flex-col overflow-hidden border border-primary-500 bg-light-500 dark:bg-dark-500">
    <NuxtImg provider="uploadcare" :src="cover ?? ''" :alt="title" :width="640" :height="Math.round(640 / (16 / 9))"
      fit="cover" format="auto" loading="lazy" quality="smart"
