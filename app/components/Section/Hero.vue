...
<template>
  <section id="hero" class="relative mb-8 grid grid-cols-3 grid-rows-[repeat(3,min-content)] items-center gap-y-[4.5rem] overflow-hidden pt-24 md:pt-32 lg:grid-rows-1 lg:pt-0">
