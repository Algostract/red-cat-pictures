...
<template>
  <section
    id="hero"
    class="grid h-dvh grid-cols-3 grid-rows-[repeat(3,min-content)] items-center gap-y-[4.5rem] overflow-hidden pt-24 text-white md:h-[calc(100vh-4rem)] md:pt-32 lg:grid-rows-1 lg:pt-0">
    <NuxtVideo
