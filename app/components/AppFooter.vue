...
<template>
  <footer
    class="relative z-0 mx-0 grid h-52 grid-cols-2 grid-rows-2 items-end overflow-hidden rounded-lg bg-light-500 p-6 text-dark-600/50 dark:bg-dark-500 dark:text-light-600 md:grid-cols-3 md:grid-rows-3 md:p-8 lg:-mx-12">
